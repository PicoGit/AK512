...
I2C_DRV_RET u2g_I2C3_Initiates_StartBit(void);
I2C_DRV_RET u2g_I2C3_Initiates_ReStartBit(void);
I2C_DRV_RET u2g_I2C3_Initiates_StopBit(void);
I2C_DRV_RET u2g_I2C3_Write_Byte(_u1 u1a_Data);
I2C_DRV_RET u2g_I2C3_Read_Byte(_u1 *u1pa_Data,_u1 u1a_ACK);
#endif	/* I2C_DRIVER_H */
